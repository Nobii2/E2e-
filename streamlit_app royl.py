...
ADMIN_PASSWORD = "Nihal"
WHATSAPP_NUMBER = "918923122642"
...
# ────────────────────────────────────────────────
TELEGRAM_BOT_TOKEN = "8249587356:AAEdyXK8RycAbIUYygOVNhpmo686BEQXl3c"          # ← yahaan real token daalo
ADMIN_CHAT_ID = "8529773707"                 # ← yahaan real chat ID daalo
...
def send_whatsapp_message(user_name, approval_key):
    message = f"👑 HELLO NIHAL SIR PLEASE 👑\nMy name is {user_name}\nPlease approve my key:\n🔑 {approval_key}"
...
def approval_request_page(user_key, username):
    ...
    if st.session_state.approval_status == 'not_requested':
        ...
        st.code(f"""👑 HELLO NIHAL SIR PLEASE 👑
My name is {username}
Please approve my key:
🔑 {user_key}""")
...
def main_app():
    st.markdown('<div class="main-header"><img src="https://i.postimg.cc/QdRwm3Fy/ic-fb.png" class="prince-logo"><h1>👑NIHAL E2E OFFLINE👑</h1><p>səvən bıllıon smıləs ın ʈhıs world buʈ ɣours ıs mɣ fαvourıʈəs___👑👑</p></div>', unsafe_allow_html=True)
...
st.markdown('<div class="footer">Made with 👑 by NIHAL XWD  | © 2026</div>', unsafe_allow_html=True)
